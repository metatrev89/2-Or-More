...
const AREA_QUESTIONS: Record<string, string[]> = {
  ...
  // Catch-all: the optional ask, then a why if they named something (Sept 14).
  open_capture: [
    'That’s all seven areas captured. Before I write these — is there anything else you want to hold in this practice that we didn’t cover? Or just say "that’s it" and I’ll get to work.',
    'Got it. Why does that one matter to you — what does holding it change?',
  ],
};
